...
\textbf{Context and equipment:} In the context of the lab study we make use of the internet \bjarke{refrase}, a laptop for the users to use, a projector to be able to observe their interaction with the system during the evaluation, assignments to be solved by the users and a questionare in paper format. \\ \\
